...
const EXACT_TRANSLATIONS: Record<string, string> = {
  ...
  "Google Speech-to-Text Key (JSON)": "Google Speech-to-Text Key（JSON）",
  ...
  "IBM Watson Speech-to-Text cloud service": "IBM Watson Speech-to-Text 云服务",
  "If macOS says \"App is damaged\"": "如果 macOS 提示“App is damaged”",
  "If not provided, LLM general knowledge is used for company research, which may be outdated. Get your API key from the": "如果不提供，公司研究会退回使用 LLM 的通用知识，信息可能过时。你可以在这里获取 API Key：",
  ...
  "Microsoft Azure Cognitive Services STT": "Microsoft Azure Cognitive Services STT",
  "More Stealth": "更强隐蔽性",
  ...
  "Real-time streaming transcription via Deepgram WebSocket": "通过 Deepgram WebSocket 实现实时流式转录",
  "Recap": "总结",
  ...
  "Required for Google Cloud Speech-to-Text.": "Google Cloud Speech-to-Text 必填。",
  "Required for accurate speech recognition.": "为了保证识别准确度，此项为必填。",
  "Requires a Groq API Key to be configured below.": "需要先在下方配置 Groq API Key。",
  "Reset": "重置",
  "Reset / Cancel": "重置 / 取消",
