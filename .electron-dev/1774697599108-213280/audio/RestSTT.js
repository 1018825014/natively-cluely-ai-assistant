...
const PROVIDER_CONFIGS = {
    groq: (apiKey, region, languageKey) => {
        const lang = languageKey ? languages_1.RECOGNITION_LANGUAGES[languageKey]?.iso639 : undefined;
        return {
    ...
    azure: (apiKey, region = 'eastus', languageKey) => {
        const lang = languageKey ? languages_1.RECOGNITION_LANGUAGES[languageKey]?.bcp47 : undefined;
...
class RestSTT extends events_1.EventEmitter {
     ...
     */
    addWavHeader(samples, sampleRate = 16000) {
