 ...
 */
exports.MEETING_RAG_SYSTEM_PROMPT = `你是一名会议助手。请只根据给出的会议摘录回答问题。
 ...
 */
exports.GLOBAL_RAG_SYSTEM_PROMPT = `你是一名会议记忆助手。请基于多场会议的信息回答问题。
 ...
 */
exports.NO_CONTEXT_FALLBACK = `我没在这场会议里找到和这个问题直接相关的内容。你可以换个说法试试，或者看看是不是在别的时间点提到过。`;
/**
 * Global search fallback
 */
exports.NO_GLOBAL_CONTEXT_FALLBACK = `我没在你可访问的会议记录里找到关于这件事的讨论。也有可能它出现在我目前拿不到的会议里。`;
/**
 * Partial match fallback
 */
exports.PARTIAL_CONTEXT_FALLBACK = `我找到了一些相关讨论，但不敢百分之百确定这就是你要的答案。我先把最相关的内容给你：`;
/**
