...
electron_1.contextBridge.exposeInMainWorld("electronAPI", {
    ...
    openTraceWindow: () => electron_1.ipcRenderer.invoke("open-trace-window"),
    getRawTranscriptState: () => electron_1.ipcRenderer.invoke("raw-transcript:get-state"),
    openRawTranscriptWindow: () => electron_1.ipcRenderer.invoke("open-raw-transcript-window"),
    openSttCompareWindow: () => electron_1.ipcRenderer.invoke("open-stt-compare-window"),
    openPromptLabWindow: (payload) => electron_1.ipcRenderer.invoke("open-prompt-lab-window", payload),
    getPromptLabActionPreview: (action, context) => electron_1.ipcRenderer.invoke("prompt-lab:get-action-preview", action, context),
    getPromptLabFixedOverrides: () => electron_1.ipcRenderer.invoke("prompt-lab:get-fixed-overrides"),
    setPromptLabFixedOverride: (payload) => electron_1.ipcRenderer.invoke("prompt-lab:set-fixed-override", payload),
    resetPromptLabFixedOverride: (payload) => electron_1.ipcRenderer.invoke("prompt-lab:reset-fixed-override", payload),
    setPromptLabDynamicOverride: (payload) => electron_1.ipcRenderer.invoke("prompt-lab:set-dynamic-override", payload),
    resetPromptLabDynamicOverride: (payload) => electron_1.ipcRenderer.invoke("prompt-lab:reset-dynamic-override", payload),
    resetPromptLabActionDynamicOverrides: (payload) => electron_1.ipcRenderer.invoke("prompt-lab:reset-action-dynamic-overrides", payload),
    onRawTranscriptUpdate: (callback) => {
        const subscription = (_, data) => callback(data);
        electron_1.ipcRenderer.on("raw-transcript:update", subscription);
        return () => {
            electron_1.ipcRenderer.removeListener("raw-transcript:update", subscription);
        };
    },
    ...
    onPromptLabFocusAction: (callback) => {
        const subscription = (_, action) => callback(action);
        electron_1.ipcRenderer.on("prompt-lab:focus-action", subscription);
        return () => {
            electron_1.ipcRenderer.removeListener("prompt-lab:focus-action", subscription);
        };
    },
    ...
    setPhoneInterviewerMode: (enabled) => electron_1.ipcRenderer.invoke("set-phone-interviewer-mode", enabled),
    getPhoneInterviewerMode: () => electron_1.ipcRenderer.invoke("get-phone-interviewer-mode"),
    ...
    mergeLiveTranscriptSegmentWithPrevious: (payload) => electron_1.ipcRenderer.invoke("live-transcript:merge-with-previous", payload),
    ...
    beginManualAnswerCapture: () => electron_1.ipcRenderer.invoke("begin-manual-answer-capture"),
    endManualAnswerCapture: () => electron_1.ipcRenderer.invoke("end-manual-answer-capture"),
    ...
    profilePreviewResumeImport: (payload) => electron_1.ipcRenderer.invoke('profile:preview-resume-import', payload),
    profileApplyResumeImport: (payload) => electron_1.ipcRenderer.invoke('profile:apply-resume-import', payload),
    ...
    projectLibraryUpdateProject: (project) => electron_1.ipcRenderer.invoke('projectLibrary:updateProject', project),
    ...
    projectLibraryGetProjectDetail: (projectId) => electron_1.ipcRenderer.invoke('projectLibrary:getProjectDetail', projectId),
    projectLibraryListAssets: (projectId) => electron_1.ipcRenderer.invoke('projectLibrary:listAssets', projectId),
    projectLibraryUpdateAssetText: (payload) => electron_1.ipcRenderer.invoke('projectLibrary:updateAssetText', payload),
    projectLibraryDeleteAsset: (assetId) => electron_1.ipcRenderer.invoke('projectLibrary:deleteAsset', assetId),
    projectLibraryListRepos: (projectId) => electron_1.ipcRenderer.invoke('projectLibrary:listRepos', projectId),
    projectLibraryReplaceRepo: (payload) => electron_1.ipcRenderer.invoke('projectLibrary:replaceRepo', payload),
    projectLibraryReindexRepo: (payload) => electron_1.ipcRenderer.invoke('projectLibrary:reindexRepo', payload),
    projectLibraryDeleteRepo: (payload) => electron_1.ipcRenderer.invoke('projectLibrary:deleteRepo', payload),
